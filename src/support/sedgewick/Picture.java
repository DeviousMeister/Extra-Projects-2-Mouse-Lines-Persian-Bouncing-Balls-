...
import support.cse131.ResizeJLabel;
 ...
 */
public final class Picture implements ActionListener, Serializable {
    /**
	 * 
	 */
	private transient BufferedImage image;               // the rasterized image
   ...
   /**
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
    		...
    		ImageIO.write(image, "png", out); // From StackOverflow: png is lossless
    }
